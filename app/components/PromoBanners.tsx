        ...
        <section className="py-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <ScrollReveal animation="reveal-left">
                    <div className="promo-banner promo-banner-green flex items-center p-8 cursor-pointer hover:shadow-lg transition-shadow h-full">
                ...
                <ScrollReveal animation="reveal-right">
                    <div className="promo-banner promo-banner-dark flex items-center p-8 cursor-pointer hover:shadow-lg transition-shadow h-full">
                        <div className="flex-1 z-10">
